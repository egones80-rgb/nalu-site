      ...
      <div className="container-nalu">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          {dentistas.map((d, i) => (
            ...
            >
              {/* Placeholder retrato — silhouette em claro */}
              <div className="relative aspect-[5/4] overflow-hidden bg-gradient-to-br from-emerald-50 via-emerald-100/40 to-zinc-100">
                <div
                  ...
                  style={{
                    background:
                      "radial-gradient(circle at 50% 30%, rgba(4,120,87,0.18), transparent 60%)",
                  }}
                />
                <div className="absolute inset-0 flex items-end justify-center pb-2">
                  <svg
                    viewBox="0 0 200 220"
                    className="w-2/3 h-full text-emerald-700/15"
                    fill="none"
                    stroke="currentColor"
                    strokeWidth="0.8"
                    aria-hidden="true"
                  >
                    ...
                    <path d="M30 220 Q30 140 100 130 Q170 140 170 220" />
                  </svg>
                </div>
